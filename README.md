...
- 🏢 **Configuración** — datos de la empresa (incluida **moneda configurable**: bolívares, dólares o euros), **idioma de la interfaz** (Español/English/Português), **notificaciones del sistema** para stock bajo y lotes por vencer, gestión de usuarios y **copias de seguridad** (backup/restauración) **cifradas con contraseña y portables a cualquier computadora**.
...
- 🔑 **Licenciamiento** — periodo de prueba de 15 días y activación **Pro** por máquina con clave firmada (RSA, 100% offline). La versión Pro desbloquea importación masiva, exportación de reportes (PDF/CSV), etiquetas de código de barras y copias de seguridad.
